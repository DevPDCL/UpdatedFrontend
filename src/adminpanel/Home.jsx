      ...
      <section className="bg-white w-screen  h-screen overflow-auto">
        <div className=" bg-white">
          <div class="grid grid-cols-12">
            ...
            <div class="col-span-10 overflow-scroll  flex flex-wrap items-center justify-center z-10 p-5 gap-3 w-full bg-white">
              <div class="w-[300px] h-[200px] p-6 bg-white border border-[#161616] rounded dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <h5 class="mb-2 text-2xl font-bold tracking-tight text-[#161616] dark:text-white">
                    Admin
                  </h5>
                </a>
                <hr className=" border-[#161616]"></hr>
                <div className="flex flex-row p-5 ">
                  <div className="bg-[#161616] rounded p-2">
                    <svg
                      className="w-[40px] h-[40px] fill-[#ffffff]"
                      viewBox="0 0 448 512"
                  ...
                  <h1 className="text-[#161616] text-[32px] font-extrabold pl-20 pt-3">
                    31
                  </h1>
                </div>
              </div>
