...
const Nav = () => {
  ...
  return (
    <nav
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between min-h-[44px] py-1.5">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="hidden lg:flex items-center gap-2 px-2.5 py-1 rounded-full bg-white/10 text-white/90">
              <div
                className={clsx(
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              <span className="text-xs font-medium font-ubuntu group-hover:text-white">Dhanmondi-HO (24/7)</span>
            </a>
      ...
      {isEmergencyMode && (
        <div className="lg:hidden bg-gradient-to-r from-amber-50 to-orange-50 text-amber-900 py-1.5 border-b border-amber-200">
          <div className="flex items-center justify-center gap-3 px-4">
            ...
            <a
              href="tel:10636"
              className="px-2.5 py-1 bg-amber-500 text-white rounded text-sm hover:bg-amber-600 transition-colors">
              Call 10636
            </a>
          </div>
        </div>
