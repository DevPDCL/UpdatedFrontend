...
const Barishal = () => {
  const branchInfo = branch.find((b) => b.heading === "Barishal");
  const branchName = branchInfo.heading;
  const branchId = branchInfo.branchID;
  const branchForDoctor = 29;
          ...
          <div className="flex lg:item-start">
            ...
            <div className="relative mt-24 p-5">
              ...
              <p className="text-black w-full">
                {" "}
                <br />
                Popular diagnostic centre ltd. Barishal branch ensures the best
                quality of service by the best machine, best reagent, best
                technology and the best colleagues.
              </p>
            </div>
          </div>
        </div>
